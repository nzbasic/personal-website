        ...
        <div className="w-full flex justify-center pb-4 text-base">
            <div className="flex flex-col space-y-4 md:max-w-5xl px-4 w-full items-center text-white">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="mb-1"><span className="font-semibold mr-1">osu!:</span>A super cool rhythm game with a very active community, especially in NZ. Nothing better than chilling and listening to some songs while tapping along. What makes the game complete is the public API that I have made heavy use of for my projects which has been a catalyst for a lot of learning.</p>
                    ...
                    <p className="mb-4"><span className="font-semibold mr-1">Fitness:</span>I love hitting the gym 💪, I needed a better way to be active so I started going in 2020 and try to go every day! (Unless COVID lockdown 😞)</p>
